...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PandaShoppingAPI.DataAccesses.EF.PanMusic", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PandaShoppingAPI.DataAccesses.EF.PanVideo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("panMusicId")
                        .HasColumnType("int");

                    b.Property<bool>("supportStreaming")
                        .HasColumnType("bit");

                    b.Property<string>("thumbImageFileName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PandaShoppingAPI.DataAccesses.EF.PanVideo", b =>
                {
                    b.HasOne("PandaShoppingAPI.DataAccesses.EF.PanMusic", "PanMusic")
                        .WithMany("PanVideos")
                        .HasForeignKey("panMusicId")
                        .OnDelete(DeleteBehavior.NoAction)
            ...
            modelBuilder.Entity("PandaShoppingAPI.DataAccesses.EF.User_", b =>
                {
                    ...
                    b.Navigation("PanMusics");

                    b.Navigation("PanVideo");
